...
namespace qjs
{
  ...
  namespace detail
  {
    ...
    {
      static JSValue unwrap(JSContext *ctx, JSValue v) 
      {
        return v;
      }

      static JSValue wrap(JSContext *ctx, JSValue v) 
      {
        return v;
      }
    };
    ...
    struct js_traits<int32_t>
    {
      ...
      static JSValue wrap(JSContext *ctx, int32_t i) 
      {
...
*/
    ...
    struct js_traits<fwrapper<F> >
    {
      static JSValue wrap(JSContext *ctx, fwrapper<F> fw)
      {
        return JS_NewCFunction(
            ctx, [](JSContext *ctx, JSValue this_value, int argc, JSValue *argv)  -> JSValue
            {
              //if(argc < sizeof...(Args))
              //return JS_EXCEPTION;
              try
    ...
    struct js_property_traits<const char *>
    {
      ...
      static JSValue get_property(JSContext *ctx, JSValue this_obj, const char *name) 
      {
  ...
  public:
    ...
    public:
      ...
      {
        m = JS_NewCModule(ctx, name, [](JSContext *ctx, JSModuleDef *m) 
                          {

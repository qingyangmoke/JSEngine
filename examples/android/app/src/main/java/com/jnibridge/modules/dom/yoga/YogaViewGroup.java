...
public class YogaViewGroup extends ViewGroup {
    private YogaNodeGroup _yogaNodeGroup;
    public YogaViewGroup(Context context) {
        this(context, null, 0);
    }

    public YogaViewGroup(Context context, YogaNode node) {
        this(context, null, 0, node);
    }

    public YogaViewGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0, null);
    }

    public YogaViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, 0, null);
    }

    public YogaViewGroup(Context context, AttributeSet attrs, int defStyleAttr, YogaNode node) {
